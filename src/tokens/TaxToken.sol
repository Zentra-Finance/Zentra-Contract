...
contract TaxToken is ERC20, Ownable {
    ...
    constructor(
        ...
        require(msg.sender != serviceFeeReceiver_, "Owner and marketing wallet cannot be the same");
        require(msg.value >= serviceFee_, "Service fee is not enough!");
        ...
        _pancakePair = IUniswapV2Factory(IUniswapV2Router02(_pancakeRouter).factory()).createPair(
            address(this), IUniswapV2Router02(_pancakeRouter).WETH()
        );
